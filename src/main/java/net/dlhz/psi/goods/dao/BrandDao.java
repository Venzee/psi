...
public class BrandDao extends BaseDao {
	...
	public boolean updateBrandById(Map<String, Object> data) {
		try {
			this.updateSourceById("psi_goods_brand", data);
		} catch (SQLException e) {
			e.printStackTrace();
			return false;
		}
	...
	public List<Map<String, Object>> queryBrand(List<Object> params) {
		...
		String sql = "select b.id,b.name,b.ename,b.logo,b.remark,b.status,b.createDate,i.name as sortname from psi_goods_brand b left join psi_goods_sort i on i.id = b.sortId order by b.id desc limit ? , ?";
		try {
